...
phamous2day.Game = function() {};

phamous2day.Game.prototype = {
  ...
  createPlayer: function() {
    this.player = this.game.add.sprite(10, 172, 'player');
  ...
  createPlayerAnimations: function(){
    this.player.animations.add('right', [6, 7], 6, true);
    this.player.animations.add('left', [4, 5], 6, true);
  },
  ...
  playerStand: function() {
    ...
    this.setMovementSprite(this.player, 5, 6);
  },
  ...
  playerJump: function() {
    this.setMovementSprite(this.player, 1, 10);
  ...
  playerFall: function() {
    this.setMovementSprite(this.player, 2, 9);
  },

  playerDuck: function() {
    this.setMovementSprite(this.player, 3, 8);
  },
  ...
  createBMG: function() {
    this.bmg = this.game.add.audio('level', .3, true);
  ...
  goombaHit: function(player, goomba) {
    ...
    if(hitY = goomba.height) {
      this.setMovementSprite(player, 0, 11);
      this.fireBallSound.play('', 0, 7, false, false);
    } else {
  ...
  npcs: [
    { gid: 675, name: 'mario', message: 'Ate, who has gotten you so kilig?' },
    { gid: 676, name: 'yoshi', message: 'I can help you with your mission of love.' },
    { gid: 677, name: 'luigi', message: 'I\'m so proud of you Andrea.' },
    { gid: 678, name: 'toad', message: 'Ahh did you find a pogi prince for me? Charot, you go girl!' },
    { gid: 679, name: 'funky', message: 'You both are too sweeeeet!!!' },
    { gid: 680, name: 'diddy', message: 'Come back to Hawaii anytime.' },
    { gid: 681, name: 'fox', message: 'Dave\'s American? But he\'s so respectful!' },
    { gid: 682, name: 'pikachu', message: 'My brother told me lots about you.' },
    { gid: 683, name: 'link', message: 'I love my son take care of him.' },
  ],
